...
(function(){
  ...
  // 绘制功能
  document.write('<script type="text/javascript" src="'+bmapcfg.home+'DrawingManager_min.js"></script>');
  // 判断是否在多边形内
  document.write('<script type="text/javascript" src="'+bmapcfg.home+'GeoUtils.js"></script>');
})();
///////////////////////////////////////////////////////////////////
