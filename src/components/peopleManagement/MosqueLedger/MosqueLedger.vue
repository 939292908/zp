 ...
 * @LastEditTime : 2019-12-20 10:43:54
 * @LastEditors  : Please set LastEditors
 -->
<template>
  <div class="right-content-box">
    <div class="mapManagemen-header">
      <h2 class="map-title">历年来清真寺教职人员</h2>
      <!-- 查询条件区域 -->
    ...
    <div class="mapManagemen-content">
      ...
      <div class="action-list">
        ...
        <i-table
          ...
          :columns="columns"
          :data="tableList"
          :no-data-text="noTableData"
        >
          <template slot-scope="{ row, index }" slot="actionBtn">
            <i-button
              v-if="hasFunAuth(constantFunMap.FUN_Online_MosqueLedger_View_ID)"
              size="small"
              type="primary"
...
export default {
  ...
  methods: {
    ...
    getOptionList() {
      ...
      //职位
      tool.getMosquePositionList(this).then(res => {
