...
<template>
  <div class="verifyLayout-box">
    ...
    <!-- 弹框-退回原因 -->
    <MyPanel class="reason" :isShowModal="modalShow.reasonModalShow" :cancel="cancelReasonModal" :ok="cancelReasonModal" :showCancelBtn="false" okBtnText="关闭" title="退回原因">
    ...
    <!-- 弹框-审核通过 -->
    <MyPanel :isShowModal="modalShow.passModalShow" :ok="okPassModal" :cancel="cancelPassModal" okBtnText="确认通过" title="确认通过">
    ...
    <!-- 弹框-审核退回 -->
    <MyPanel :isShowModal="modalShow.sendBackModalShow" :ok="oksendBackModal" :cancel="cancelsendBackModal" title="无证人员信息变更退回">
