...
<template>
  <!-- 档案信息 -->
  <div v-if="tpInfo && tpInfo.properties" class="inforModal-wrap" @click.self="handleModel">
    <div class="inforModal">
      ...
      <div class="cont-box">
        ...
        ></personInforForm>
        <MapInforForm v-if="showMapInfo" :mapId="mapId" :mapType="mapType"></MapInforForm>
      </div>
    </div>
  </div>
</template>
    ...
    tpInfo: {
      handler(val) {
        if (val && val.properties) {
          if (val.properties.SFZHM != null) {
            this.idNumber = val.properties.SFZHM;
            this.collectId = val.properties.collectId;
            this.showPersonInfo = true;
            this.showMapInfo = false;
          }
          if (val.properties.MAP_ID != null) {
            this.mapId = val.properties.MAP_ID;
            this.mapType = val.properties.mapType;
