...
<script>
    import { oneOf, findBrothersComponents, findComponentsUpward } from 'iview/src/utils/assist';
    ...
    export default {
        ...
        computed: {
            wrapStyles () {
              let obj = {
                zIndex: this.modalIndex < 1000 ? this.zIndex : this.modalIndex
              };              
              return Object.assign(obj,this.maskStyle)
            },
            wrapClasses () {
                return [
                    `${prefixCls}-wrap`,
            ...
            visible (val) {
                if (val === false) {
                    this.timer = setTimeout(() => {
                        ...
                        const brotherDrawers = findBrothersComponents(this, 'DDrawer') || [];
                        const parentDrawers = findComponentsUpward(this, 'DDrawer') || [];
