<template>
  <div class="index" @click="uploadImg=false;">
    ...
    <!-- 图片标题 -->
    <div class="div-title" @click="toIndex" style="cursor:pointer;" title="返回主页">
      <!-- src="../../../static/images/search/full-search.png" -->
      <img alt="全文检索" :src="image">
    </div>
    <!-- 搜索框 -->
    <div class="wrapper">
      <div class="box">
        ...
        <div class="search-box">
          <i-button class="search-default" @click="toRelationPage">搜索一下</i-button>
          ...
          <div class="input">
            ...
            <input type="text" placeholder="请输入查询关键字"  v-model="keyword" @keyup.enter="toRelationPage"/>
          </div>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      keyword : '',
      uploadList: [],
      image:'./static/images/search/full-search' + this.$config.project.localSuffix +'.png'
    }
  },
  methods : {
    toIndex () {
