 ...
 * @LastEditTime: 2019-11-11 18:22:29
        ...
        <Tabs v-model="tabIndex" type="card">
          ...
          <template v-if="showPersonInfoTab">
            <TabPane name="t1" :index="2" label="人员详情">
              ...
              <ReligiousFormObjectiveView ref="formObjectiveView" :idNumber="idNumber"></ReligiousFormObjectiveView>
            </TabPane>
          </template>
        </Tabs>
      </Drawer>
...
export default {
  name: "ReligiousMapGraph",
  mixins: [mapMixin],
  components: {
    // DDrawer,
    MapOverview: () => import("@/components/assembly/MapOverview"),
    ReligiousWorkObjective: () => import("./formObjective"),
    // ReligiousFormObjectiveView: () => import("./formObjectiveView"),
    ReligiousFormObjectiveView: () => import("../personObjectView"),
    ReligiousFormTpType: () => import("./formTpType"),
  ...
  methods: {
    ...
    handlePersonEditClick() {
      ...
      this.$nextTick(() => {
        if (this.$refs.form) {
          this.$refs.form.onStartTimeChange();
          this.$refs.form.onEndTimeChange();
        }
      });
    },
