 ...
 * @LastEditTime: 2019-11-15 13:29:12
...
<template>
  <div class="form-objective-view">
    ...
    <!-- 出境信息 -->
    <div class="panel-title panel-info border">出境信息</div>
    <div class="form-info">
      <div class="form-item">
      ...
      <div class="form-item">
        ...
        <div class="form-content">{{form.newPersonOutboundRelationInfo.outboundIscancel}}</div>
      </div>
      <div class="form-item">
        <div class="form-label">出国证件种类：</div>
        <div class="form-content">{{form.newPersonOutboundRelationInfo.outboundCertificatetype}}</div>
      </div>
      <div class="form-item">
        <div class="form-label">证件号：</div>
        <div class="form-content">{{form.newPersonOutboundRelationInfo.outboundNumber}}</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    bindFormValue(form) {
      ...
      // let formOtb = this.form.newPersonOutboundRelationInfo;
      // let resOtb = form.personOutboundRelationInfo;
      // formOtb.outboundCertificatetype = resOtb.outboundCertificatetype; // 出国证件种类
      // formOtb.outboundIscancel = resOtb.outboundIscancel; // 是否注销中国国籍
      // formOtb.outboundNumber = resOtb.outboundNumber; // 证件号
      // formOtb.outboundTime = this.$moment(resOtb.outboundTime).format("YYYY-MM-DD"); // 出境时间
      this.form.newPersonOutboundRelationInfo = form.personOutboundRelationInfo;
      this.form.newPersonOutboundRelationInfo.outboundTime = this.$moment(
        this.form.newPersonOutboundRelationInfo.outboundTime
      ).format("YYYY-MM-DD");
    }
  },
  watch: {
