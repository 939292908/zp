 ...
 * @LastEditTime: 2019-10-24 16:48:40
...
// import SocietyWorkObjective from "./formObjective";
// import SocietyFormObjectiveView from "./formObjectiveView";
// import SocietyFormTpType from "./formTpType";
import {
  getModalMaxIndex,
  createRMenu,
  setMenuData
...
export default {
  name: "SocietyMapGraph",
  mixins: [mapMixin],
  components: {
    // DDrawer,
    MapOverview: () => import("@/components/assembly/MapOverview"),
    SocietyWorkObjective: () => import("./formObjective"),
    // SocietyFormObjectiveView: () => import("./formObjectiveView"),
    // SocietyFormObjectiveView: () => import("../personObjectView"),
    SocietyFormObjectiveView: () => import("../personObjectView"),
    SocietyFormTpType: () => import("./formTpType")
  },
  data() {
    return {
      loadModal: false,
