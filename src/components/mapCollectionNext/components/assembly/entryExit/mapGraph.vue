 ...
 * @LastEditTime: 2019-10-24 17:37:45
        ...
        <Tabs v-model="tabIndex" type="card">
          ...
          <template v-if="showPersonInfoTab">
            <TabPane name="t1" :index="2" label="人员详情">
              ...
              <EntryExitFormObjectiveView ref="formObjectiveView" :idNumber="idNumber"></EntryExitFormObjectiveView>
            </TabPane>
          </template>
        </Tabs>
      </Drawer>
...
// import EntryExitWorkObjective from "./formObjective";
// import EntryExitFormObjectiveView from "./formObjectiveView";
// import EntryExitFormTpType from "./formTpType";
import {
  getModalMaxIndex,
  createRMenu,
  setMenuData
...
// import { graphData } from "./socialMock.js";
export default {
  name: "EntryExitMapGraph",
  mixins: [mapMixin],
  components: {
    // DDrawer,
    MapOverview: () => import("@/components/assembly/MapOverview"),
    EntryExitWorkObjective: () => import("./formObjective"),
    // EntryExitFormObjectiveView: () => import("./formObjectiveView"),
    EntryExitFormObjectiveView: () => import("../personObjectView"),
    EntryExitFormTpType: () => import("./formTpType")
  },
  data() {
    return {
      loadModal: false,
  ...
  methods: {
    ...
    buildOpt(mapType) {
      ...
      let option = {
        ...
        height: height,
        offsetTop: 55,
        type: mapType || "social", //social,level
        showToptag: true,
        allowDrag: true,
        ...
        node: {
          //节点的配置信息
          // isEdit: true, //是否扩展编辑操作按钮,默认为false
          borderColor: "#d7d7d7",
          top: "",
          right: "添加",
          bottom: "",
        ...
        sideButtonEvt: function(node, sideButton, event) {
          ...
          if (node.data) {
            ...
            me.workObjectPersonIdNumber = node.data.oid;
          } else {
            me.personIdNumber = node.properties.SFZHM;
            me.workObjectPersonIdNumber = node.oid;
          }
        },
        // 案件线索的点击事件
      ...
      if (nodeEditConfig && this.isCanEdit && me.mapFlag == "1") {
        nodeEditConfig.isEdit = true;
        nodeEditConfig.borderColor = "#d7d7d7";
        nodeEditConfig.right = "添加";
    ...
    getGraphData(mapType) {
      ...
      apis.GET_ONLINE_MAP_LABEL_BY_ID(obj).then(res => {
        ...
        me.$parent.showWorkButton = false;
        if (me.mapFlag == "1") {
          tmpData = this.parseSocialData(tmpData);
        }
    ...
    initMenu() {
      ...
      d3.select(".nodes")
        ...
        .on("contextmenu", function(e) {
          ...
          createRMenu(
            "rMenu",
            setMenuData(me, null, null, me.opt.type == "social"), // 菜单data数据
    ...
    handlePersonEditClick() {
      ...
      if (me.isFirstworkObject) {
        ...
        me.workObjectPersonIdNumber = me.coreIdNumber;
        let nodeTmp = me.currentRightMenuNode.gxmc;
        me.relation = {
          node: nodeTmp,
