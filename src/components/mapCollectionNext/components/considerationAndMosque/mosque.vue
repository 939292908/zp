<template>
  <Modal
    ...
    width="80%"
    footer-hide
    :title="villageAllInfo.name+'清真寺详情'"
    :mask-closable="false"
    @on-ok="ok"
...
import edit from "./mEditView";
import add from "./mAdd";
