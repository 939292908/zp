 ...
 * @LastEditTime: 2019-12-18 11:32:49
  ...
  <div class="info-box">
    <div class="left-anchor">
      <Anchor show-ink container=".right-form">
        ...
        <AnchorLink href="#committeeInfo" title="村两委任职信息" />
      </Anchor>
    </div>
    <div class="right-form">
      ...
      <div class="infoItem" id="committeeInfo">
        ...
        <div class="form-content">
          <committeeInfoForm ref="committeeInfoForm" :data="formData"></committeeInfoForm>
        </div>
      </div>
    </div>
...
import committeeInfoForm from "./committeeInfoForm";
